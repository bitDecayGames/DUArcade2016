window.onload = () => {
    ...
    game.state.add("create", new CreateLevel());
...
/*
This function swallows the [BACKSPACE], [SPACE], [UP], [DOWN], [LEFT], [RIGHT] keys so that the window
doesn't scroll around while people are trying to play the game.
 */
window.onkeydown = function(e) { return e.keyCode != 8 && e.keyCode != 32 && e.keyCode != 37 && e.keyCode != 38 && e.keyCode != 39 && e.keyCode != 40; };